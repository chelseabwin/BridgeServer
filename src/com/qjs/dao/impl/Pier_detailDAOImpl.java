...
public class Pier_detailDAOImpl extends HibernateDaoSupport implements Pier_detailDAO {
	...
	public Object addEntity(Object obj) {
		return super.getHibernateTemplate().save((Pier_detail)obj);
	}

	@Override
	public int deleteEntityByProperty(String propertyName, Object value, Type type) {
		String hql = "delete Pier_detail as u where u."+propertyName+"=?";
		Query qobj = this.getNewSession().createQuery(hql);
	...
	public void updateEntity(Object obj) {
		super.getHibernateTemplate().update((Pier_detail)obj);
	}

	@SuppressWarnings("unchecked")
	@Override
	public List<?> findEntityListByProperty(String propertyName, Object value, Type type) {
		String hql = "from Pier_detail as u where u."+propertyName+"=?";
		Query qobj = this.getNewSession().createQuery(hql);
		qobj.setParameter(0, value, type);
		return (List<Pier_detail>)qobj.list();
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public List<?> findEntityListByPropertyWithSql(String propertyName) {
		String sql = "select * from Pier_detail where bridge_code=?";
	...
	public Map<?,?> findEntityListByProperties(QueryItems qi) {
		...
		Criteria criteria = this.getNewSession().createCriteria(Pier_detail.class);
