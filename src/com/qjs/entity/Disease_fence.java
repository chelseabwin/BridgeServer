...
public class Disease_fence implements java.io.Serializable {
	...
	public Disease_fence() {
		
	}
	
	public Disease_fence(Integer id, String bg_id, String parts_id, String item_name, String rg_feature, 
