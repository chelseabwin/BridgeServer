...
public class Disease_sidewalk implements java.io.Serializable {
	...
	public Disease_sidewalk() {
		
	}
	
	public Disease_sidewalk(Integer id, String bg_id, String parts_id, String item_name, String rg_feature, 
