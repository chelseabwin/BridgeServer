...
public class Disease_regstruc implements java.io.Serializable {
	...
	public Disease_regstruc() {
		
	}
	
	public Disease_regstruc(Integer id, String bg_id, String parts_id, String item_name, String rg_feature, 
