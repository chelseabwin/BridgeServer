...
public class Disease_sidewalkBizImpl implements Disease_sidewalkBiz {
	...
	public List<Map<String, Object>> getAllDisease_sidewalkByBridgeCode(String bridgeCode) {
		List<Disease_sidewalk> diseaselist = (List<Disease_sidewalk>) disease_sidewalkDAO.findEntityListByPropertySort("bg_id", "u.parts_id, u.item_name, u.rg_feature", bridgeCode, StringType.INSTANCE);
