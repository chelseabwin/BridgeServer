...
public class Disease_fenceBizImpl implements Disease_fenceBiz {
	...
	public List<Map<String, Object>> getAllDisease_fenceByBridgeCode(String bridgeCode) {
		List<Disease_fence> diseaselist = (List<Disease_fence>) disease_fenceDAO.findEntityListByPropertySort("bg_id", "u.parts_id, u.item_name, u.rg_feature", bridgeCode, StringType.INSTANCE);
