						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form id="bridge_view" action="" class="form-horizontal" method="post">
												...
												<table class="table table-bordered">
													<tbody>
												      <tr>
												         ...
												         <td class="alert alert-info" width='100'><s:property value="%{#request.disease_atcapping.item_name}"/></td>
												         <th width='100'>部件编号</th>
												         <td class="alert alert-info" width='100'><s:property value="%{#request.disease_atcapping.parts_id}"/></td>
												      </tr>
												      
												      <tr>
												         <th>病害类型</th>
												         <td class="alert alert-info"><s:property value="%{#request.disease_atcapping.rg_feature}"/></td>
												         <th>病害描述</th>
												         <td class="alert alert-info"><s:property value="%{#request.disease_atcapping.add_content}"/></td>
												      </tr>
												      ...
												      <tr>
												         ...
												         <th>检测时间</th>
												         <td class="alert alert-info"><s:property value="%{#request.disease_atcapping.detect_time}"/></td>
												      </tr>
												...
												<div>
													<a href="#" class="btn blue" onclick="loadPage('/BridgeServer/disease!showAtcapping?id=<s:property value="%{#request.disease_atcapping.id}"/>&table_name=<s:property value="table_name"/>&bg_id=<s:property value="bg_id"/>&bg_name=<s:property value="bg_name"/>');"><i class="m-icon-swapright m-icon-white"></i> 修改</a>
