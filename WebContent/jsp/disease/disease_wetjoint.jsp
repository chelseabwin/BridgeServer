								...
								<input type="hidden" name="bg_id" value="<s:property value="#request.bg_id"/>">
												...
												<div class="control-group" id="od_div">
													...
													<div class="controls">
														...
														<s:select class="medium m-wrap" name="sp_otherDisease" id="spOtherDiseaseId" list="{'[1]混凝土保护层厚度','[2]钢筋锈蚀','[3]混凝土碳化','[4]混凝土强度','[5]跨中挠度','[6]结构变位','[7]预应力构件损伤','[8]其他'}" />
												...
												<div class="form-actions">
													<a href="#" class="btn blue" onclick="submitData('/BridgeServer/disease!changeWetjoint');"><i class="icon-ok"></i> 保存</a>
													<s:if test="#request.id!=null">
														<a href="#" class="btn" onclick="loadPage('/BridgeServer/disease!viewDisease?table_name=disease_wetjoint&id=<s:property value="id"/>&bg_name=<s:property value="bg_name"/>&bg_id=<s:property value="bg_id"/>');">取消</a>
													</s:if>
													<s:else>
														<a href="#" class="btn" onclick="loadPage('/BridgeServer/disease!getBaseDiseaseList?table_name=disease_wetjoint&bg_name=<s:property value="bg_name"/>&bg_id=<s:property value="bg_id"/>');">取消</a>
													</s:else>
												</div>
