								...
								<form id="bridge_view" action="" class="form-horizontal" method="post">
												...
												<table class="table table-bordered">
													<tbody>
												      ...
												      <s:if test="#request.disease_wetjoint.rg_feature=='裂缝'">
										         	  	 <s:if test="#request.disease_wetjoint.rg_fissure!='网裂缝'">
											         	  	<tr>
														        <th>裂缝距本跨梁端起始距离</th>
										         	  ...
										         	  <s:elseif test="#request.disease_wetjoint.rg_feature!='其他病害'">
										         	  	 <tr>
													         <th>距本跨梁端起始距离</th>
													         <td class="alert alert-info"><s:property value="%{#request.disease_wetjoint.l1_start}"/></td>
													         <th>距本跨梁端终止距离</th>
										         	  ...
										         	  <tr>
												         ...
												         <th>检测时间</th>
												         <td class="alert alert-info"><s:property value="%{#request.disease_wetjoint.detect_time}"/></td>
												      </tr>
												...
												<div>
													<a href="#" class="btn blue" onclick="loadPage('/BridgeServer/disease!showWetjoint?id=<s:property value="%{#request.disease_wetjoint.id}"/>&table_name=<s:property value="table_name"/>&bg_id=<s:property value="bg_id"/>&bg_name=<s:property value="bg_name"/>');"><i class="m-icon-swapright m-icon-white"></i> 修改</a>
