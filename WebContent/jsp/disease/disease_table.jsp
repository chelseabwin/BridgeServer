...
jQuery("#table_current").html("记录总数:"+totalNumber);
	$('#page_info').bootpag({
		...
		$("#pageNo").val(num);
		getInformation('/BridgeServer/disease!getDiseaseList?table_name=<s:property value="#request.table_name"/>&bg_id=<s:property value="bg_id"/>&bg_name=<s:property value="bg_name"/>');
	});
