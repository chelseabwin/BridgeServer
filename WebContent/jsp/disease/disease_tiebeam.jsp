					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<input type="hidden" id="img_name_id" name="img_name" value="<s:property value="#request.img_name"/>">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" type="text" name="item_name" value="系梁" readOnly/>
												...
												<div class="control-group">
													...
													<div class="controls">
													    ...
													    <label class="radio">
													        <input type="radio" id="rgFeature4" name="rg_feature" value="钢筋锈蚀">&nbsp;钢筋锈蚀
													    </label>
													    
													    <label class="radio">
													        <input type="radio" id="rgFeature5" name="rg_feature" value="混凝土碳化、腐蚀">&nbsp;混凝土碳化、腐蚀
													    </label>
								...
								<input type="hidden" name="bg_id" value="<s:property value="#request.bg_id"/>">
								<input type="hidden" name="id" value="<s:property value="#request.id"/>">
								<input type="hidden" name="table_name" value="disease_tiebeam">
										...
										<div id="img_div" class="control-group">
											...
											<div class="controls">
											    ...
											    <img id="dis_img_id" src="/BridgeServer/disease_image/<s:property value="#request.bg_id"/>/<s:property value="#request.disease_image"/>" width="400" height="300" />
								...
								<div class="form-actions">
									<a href="#" class="btn blue" onclick="submitData('/BridgeServer/disease!changeTiebeam');"><i class="icon-ok"></i> 保存</a>
									<s:if test="#request.id!=null">
										<a href="#" class="btn" onclick="loadPage('/BridgeServer/disease!viewDisease?table_name=disease_tiebeam&id=<s:property value="id"/>&bg_id=<s:property value="bg_id"/>&bg_name=<s:property value="bg_name"/>');">取消</a>
									</s:if>
									<s:else>
										<a href="#" class="btn" onclick="loadPage('/BridgeServer/disease!getBaseDiseaseList?table_name=disease_tiebeam&bg_id=<s:property value="bg_id"/>&bg_name=<s:property value="bg_name"/>');">取消</a>
									</s:else>
								</div>
