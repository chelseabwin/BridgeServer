						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form id="bridge_view" action="" class="form-horizontal" method="post">
												...
												<div>
													<button class="btn blue" onclick="loadPage('/BridgeServer/disease!showWatertight?id=<s:property value="%{#request.disease_watertight.id}"/>&table_name=<s:property value="table_name"/>&bg_id=<s:property value="bg_id"/>&bg_name=<s:property value="bg_name"/>');"><i class="m-icon-swapright m-icon-white"></i> 修改</button>
