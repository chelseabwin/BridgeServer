						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form id="bridge_view" action="" class="form-horizontal" method="post">
												...
												<div>
													<button class="btn blue" onclick="loadPage('/BridgeServer/bridge!showRegstruc?id=<s:property value="%{#request.disease_regstruc.id}"/>');"><i class="m-icon-swapright m-icon-white"></i> 修改</button>
