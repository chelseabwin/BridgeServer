...
<head>
	...
	<link href="/BridgeServer/media/css/login.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<!--<img src="/BridgeServer/media/image/logo-big.png" alt="" /> -->
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		...
		<form class="form-vertical login-form" action="login" method="post">
			<h3 class="form-title">桥梁数据管理系统</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="用户名" name="loginName"/>
					</div>
				</div>
			</div>
			<div class="control-group">
	...
	<script src="/BridgeServer/media/js/jquery.validate.min.js" type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="/BridgeServer/media/js/app.js" type="text/javascript"></script>
	<script src="/BridgeServer/media/js/login.js" type="text/javascript"></script>      
